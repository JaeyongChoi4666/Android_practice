...
public class MainActivity extends AppCompatActivity {
    ...
    public void insertPerson(){
        String uriString="content://com.example.cproviderapp/person";
        ...
        values.put("name","카이사르");
        values.put("age",30);
        values.put("mobile","010-1111-1111");
    ...
    public void selectPerson(){
        try {
            ...
            println("select 결과 : "+ cursor.getCount());
            int index=0;
    ...
    public void updatePerson(){
        ...
        String[] selectionArgs=new String[]{"카이사르"};
        ContentValues values=new ContentValues();
        values.put("name","율리우스");
        values.put("age","31");
